                    ...
                    if (Menu.NmUsuUsu != nmusu)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                cmd.Dispose();
                                dr.Close();
                                sql = "SELECT * FROM BOTIJAO WHERE USURESP = '" + Menu.NmUsuUsu + "'";
                                cmd = new SqlCommand(sql, conexao);
                                dr = cmd.ExecuteReader();
                                if (dr.HasRows)
                                {
                                    cmd.Dispose();
                                    dr.Close();
                                    sql = "ALTER TABLE BOTIJAO NOCHECK CONSTRAINT ALL UPDATE BOTIJAO SET USURESP = '" + nmusu + "' WHERE USURESP = '" + Menu.NmUsuUsu + "' ALTER TABLE BOTIJAO CHECK CONSTRAINT ALL";
                                    cmd = new SqlCommand(sql, conexao);
                                    cmd.ExecuteNonQuery();
                                }
                                cmd.Dispose();
                                dr.Close();
                                sql = "SELECT * FROM LOTE WHERE USURESP = '" + Menu.NmUsuUsu + "'";
                                cmd = new SqlCommand(sql, conexao);
                                dr = cmd.ExecuteReader();
                                if (dr.HasRows)
                                {
                                    cmd.Dispose();
                                    dr.Close();
                                    sql = "ALTER TABLE LOTE NOCHECK CONSTRAINT ALL UPDATE LOTE SET USURESP = '" + nmusu + "' WHERE USURESP = '" + Menu.NmUsuUsu + "' ALTER TABLE LOTE CHECK CONSTRAINT ALL";
                                    cmd = new SqlCommand(sql, conexao);
                                    cmd.ExecuteNonQuery();
                                }
                                dr.Close();
                ...
                if (dr.HasRows)
                {
                    ...
                    if (Menu.NmUsuUsu != "GERENTE")
                    {
                        ...
                        if (dr.HasRows) {
                            cmd.Dispose();
                            dr.Close();
                            sql = "ALTER TABLE BOTIJAO NOCHECK CONSTRAINT ALL UPDATE BOTIJAO SET USURESP = ' ' WHERE USURESP = '" + Menu.NmUsuUsu + "' ALTER TABLE BOTIJAO CHECK CONSTRAINT ALL";
                            cmd = new SqlCommand(sql, conexao);
                            cmd.ExecuteNonQuery();
                        }
                        cmd.Dispose();
                        ...
                        if (dr.HasRows)
                        {
                            cmd.Dispose();
                            dr.Close();
                            sql = "ALTER TABLE LOTE NOCHECK CONSTRAINT ALL UPDATE LOTE SET USURESP = ' ' WHERE USURESP = '" + Menu.NmUsuUsu + "' ALTER TABLE LOTE CHECK CONSTRAINT ALL";
                            cmd = new SqlCommand(sql, conexao);
                            cmd.ExecuteNonQuery();
                        }
                        cmd.Dispose();
